...
FeaturedState _$FeaturedStateFromJson(Map<String, dynamic> json) {
  return _FeaturedState.fromJson(json);
}
...
abstract class $FeaturedStateCopyWith<$Res> {
  factory $FeaturedStateCopyWith(
      ...
      _$FeaturedStateCopyWithImpl<$Res, FeaturedState>;
  @useResult
  $Res call(
...
/// @nodoc
class _$FeaturedStateCopyWithImpl<$Res, $Val extends FeaturedState>
...
class _$FeaturedStateImpl implements _FeaturedState {
  ...
  @override
  String toString() {
    return 'FeaturedState(artAbstractItem: $artAbstractItem, artItem: $artItem, artAbstractItems: $artAbstractItems, artAbstractItemsSpotlight: $artAbstractItemsSpotlight, loadingState: $loadingState)';
  }
...
abstract class _FeaturedState implements FeaturedState {
  const factory _FeaturedState(
